...
# run this script:                 bash /cluster/home/elucas/thesis/cluster/subsets.sh

num_folds=3

python_script="/cluster/home/elucas/thesis/scripts/subsets.py"

# job parameters
runtime="48:00:00"  # having this too high can make the queue reduce your priority
cpus_per_task=4
mem_per_cpu="32G"
